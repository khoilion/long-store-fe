                    ...
                    <div className="max-w-[330px] w-full">
                        ...
                        <ul className="flex flex-col gap-3">
                            <li className="flex gap-4.5">
                                ...
                                332 Đ. Nguyễn Trãi Thanh Xuân Trung, Thanh Xuân, Hà Nội.
                            </li>
                            <li className="flex gap-4.5">
                                <span className="flex-shrink-0">
                                  <svg
                                ...
                                161 Đ. Nguyễn Trãi Thượng Đình, Thanh Xuân, Hà Nội
                            </li>
                            <li className="flex gap-4.5">
                                <span className="flex-shrink-0">
                                  <svg
                                ...
                                137 P. Minh Khai, Minh Khai, Hai Bà Trưng, Hà Nội
                            </li>
                            <li>
                ...
                <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
                    <div className="flex gap-5 flex-wrap items-center justify-between">
                        <p className="text-dark font-medium">
                            &copy; {year}. Mọi quyền được bảo lưu bởi LongStore
                        </p>
                        <div className="flex flex-wrap items-center gap-4">
                            <p className="font-medium">Chấp nhận :</p>

                            <div className="flex flex-wrap items-center gap-6">
                                <a href="/coming-soon" aria-label="payment system with visa card">
                                    <Image
                                ...
                                <a href="/coming-soon" aria-label="payment system with paypal">
                                    <Image
                                ...
                                <a href="/coming-soon" aria-label="payment system with master card">
                                    <Image
                                ...
                                <a href="/coming-soon" aria-label="payment system with apple pay">
                                    <Image
                                ...
                                <a href="/coming-soon" aria-label="payment system with google pay">
                                    <Image
